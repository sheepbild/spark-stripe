...
class SparkManager
{
    ...
    /**
     * The registered callbacks that return the options for a Stripe Checkout Session when adding a payment method.
     *
     * @var array
     */
    public $paymentMethodOptionsCallback = [];
    ...
    /**
     * Set the callback that should be used to determine the Stripe checkout session options when adding a payment method.
     *
     * @param  string  $billableType
     * @param  callable  $callback
     * @return void
     */
    public function paymentMethodSessionOptions($billableType, $callback)
    {
        $this->paymentMethodOptionsCallback[$billableType] = $callback;
    }

    /**
     * Get the callback that should be used to determine the Stripe checkout session options when adding a payment method.
     *
     * @param  string  $billableType
     * @return callable|null
     */
    public function getPaymentMethodSessionOptions($billableType)
    {
        return $this->paymentMethodOptionsCallback[$billableType] ?? null;
    }
